...
# --------------------------------------
# EXTRA: Leggere un File da un Percorso 📄
# --------------------------------------

# 🔹 1. Lettura da un percorso relativo
# Se il file si trova nella stessa directory dello script o in una sottocartella

with open("dati/esempio.txt", "r", encoding="utf-8") as file:
    contenuto = file.read()
    print("Contenuto del file (relativo):")
    print(contenuto)

# 🔹 2. Lettura da un percorso assoluto (sconsigliato se si vuole mantenere portabilità)
# Esempio: "C:/Users/utente/Documents/file.txt" su Windows oppure "/home/user/file.txt" su Linux

percorso_assoluto = "/percorso/assoluto/al/file.txt"
try:
    with open(percorso_assoluto, "r", encoding="utf-8") as file:
        contenuto = file.read()
        print("Contenuto del file (assoluto):")
        print(contenuto)
except FileNotFoundError:
    print("⚠️ File non trovato:", percorso_assoluto)

# 🔹 3. Lettura con os.path.join() per costruire percorsi dinamici

import os
directory_base = os.getcwd()  # es: /Users/frank/Progetto/
file_path = os.path.join(directory_base, "dati", "esempio.txt")

with open(file_path, "r", encoding="utf-8") as file:
    print("Contenuto da percorso costruito dinamicamente:")
    print(file.read())

# 🔹 4. Lettura file con pathlib (modo moderno e OOP)

from pathlib import Path

path_file = Path("dati") / "esempio.txt"
if path_file.exists():
    with path_file.open("r", encoding="utf-8") as file:
        print("Contenuto letto con pathlib:")
        print(file.read())
else:
    print(f"⚠️ Il file {path_file} non esiste.")

# 🔹 5. Lettura file in modalità binaria (per immagini, PDF, audio...)

percorso_binario = "immagini/logo.png"
with open(percorso_binario, "rb") as file:
    dati = file.read()
    print("File binario letto. Byte totali:", len(dati))

# 🔹 6. Suggerimento generale: sempre usare 'with' per gestire i file
# Questo assicura che il file venga chiuso automaticamente dopo l'uso,
# anche in caso di eccezioni o errori.
